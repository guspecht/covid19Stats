...
export class MapComponent implements OnInit{
  ...
  ngOnInit(){
    ...
    // change map here and see if works
    L.tileLayer(`https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=${environment.mapApiToken}`, {
      ...
      .subscribe(
        countryData =>{
          ...
          // .bindPopup(`${countryData.name} <br> Confirmed: ${this.confirmed}.<br> Recovered: ${this.recovered}. <br> Deaths:${this.deaths}.`).openPopup();
